...
<header>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td style="border: 0">
                <img src="${data.image_src}/images/logo_meganet_new.png" alt="Logo Meganet" style="max-height: 220px">
            </td>
...
<table border="1" cellspacing="0" cellpadding="0" width="100%" style="border-bottom: 0">
    <tr>
        ...
        <td class="bb0" style="width: 16%"><strong> customer . date_add</strong></td>
        <td class="bb0" style="width: 8.5%">
            <strong>Hora:</strong>
        </td>
...
<header>
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td style="border: 0">
                <img src="${data.image_src}/images/logo_meganet_new.png" alt=""
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                    <td class="bt0 bb0" colspan="2">
                        ...
                        fue celebrada con fecha <strong> customer . date_add</strong> _.
                    </td>
                </tr>
                <tr>
                    <td class="bt0 bb0" colspan="2">
                ...
                <tr>
                    ...
                    <td class="bt0 bl0">
                        ...
                        <strong> customer . date_add </strong>_
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td style="border: 0; width: 48%" class="tj">
                        <p><strong>PRIMERA: OBJETO DEL CONTRATO.</strong> MEGANETT se obliga a prestar el servicio de
                            Telefonía fija e Internet fijo en casa, (en adelante el Servicio) ya sea individual o
                            conjunta, de manera continua, uniforme, regular y eficiente, a cambio del pago de la tarifa,
                            plan o paquete que el SUSCRIPTOR haya seleccionado en la carátula del presente contrato, los
                        ...
                        <p>El presente contrato <strong>se regirá bajo el esquema de mensualidades fijas POR
                                ADELANTADO</strong>, es decir se va a pagar el servicio de manera previa a utilizarlo.
                        ...
                        <p>Todo lo pactado o contratado entre el SUSCRIPTOR y MEGANETT de manera verbal o electrónica se
                        ...
                        <p><strong>SEGUNDA: VIGENCIA.</strong> Este contrato <strong>NO obliga a un plazo</strong>
                            ...
                            recabar autorización de MEGANETT, únicamente se tendrá que dar aviso a este último a través
                            del mismo medio en el cual contrató el servicio o por los medios de contacto señalados en la
                            carátula.</p>
                        <p><strong>TERCERA: EQUIPO TERMINAL.</strong> Los equipos y accesorios que son necesarios para
                            recibir el SERVICIO son propiedad de MEGANETT mismos que se entregan al SUSCRIPTOR en
                            <strong>COMODATO</strong> (en préstamo). El SUSCRIPTOR se compromete a la guarda, custodia y
                            conservación del (los) equipo(s), durante todo el tiempo que se encuentre en su poder, hasta
                            la terminación del presente contrato y deberán ser devueltos al MEGANETT, presentando
                            únicamente el desgaste natural por el paso del tiempo, y por su parte el MEGANETT se obliga
                        ...
                        <p>Cuando las fallas que se presenten en el equipo y accesorios no sean atribuibles al
                            SUSCRIPTOR, MEGANETT se obliga a realizar de manera gratuita las reparaciones necesarias, en
                            tanto este contrato permanezca vigente. Ambas partes deberán coordinarse para establecer la
                        ...
                        <p>En caso de que el equipo terminal se encuentre en reparación o mantenimiento, MEGANETT debe
                            ...
                            SUSCRIPTOR está haciendo uso del servicio o le haya proporcionado un equipo sustituto.</p>
                        <p>Cuando el Equipo provisto en comodato, sea robado o sea objeto de algún siniestro, el
                            ...
                            veinticuatro horas posteriores al evento para la reposición del Equipo y para suspender el
                            cobro del SERVICIO hasta que el SUSCRIPTOR tenga otro equipo para poder recibir el SERVICIO.
                            El SUSCRIPTOR tendrá un plazo de 30 días hábiles posteriores al robo o siniestro para
                            presentar copia certificada de la constancia correspondiente levantada ante una Autoridad
                            Competente, que acredite el objeto de robo o siniestro para que no tenga costo la reposición
                            del equipo.</p>
                    </td>
                    <td style="border: 0; width: 4%"></td>
                    <td style="border: 0; width: 48%" class="tj va-t">
                        <p>Si al término o rescisión del Contrato, EL SUSCRIPTOR no devuelve al MEGANETT el Equipo que
                            le fue entregado en comodato en términos de lo previsto en este Contrato, se le hará
                            efectiva la garantía de cumplimiento de obligación consistente en un pagaré que es causal y
                            no negociable; es decir que este pagaré sólo se firma por EL SUSCRIPTOR para garantizar la
                            devolución del Equipo que le fue entregado en comodato.</p>
                        <p>Sí al finalizar la relación contractual y el SUSCRIPTOR sí haya devuelto a MEGANETT el equipo
                        ...
                        <p>En el momento en el que, el SUSCRIPTOR realice la devolución del Equipo, MEGANETT le debe
                            proporcionar una nota de recepción, la cual deberá contener el número de teléfono, nombre de
                            EL SUSCRIPTOR y nombre de la persona que lo entrega y lo recibe. EL MEGANETT se obliga a
                            devolver el pagaré suscrito en garantía del equipo establecido en el Anexo 1 al término del
                            contrato siempre y cuando EL SUSCRIPTOR entregue el Equipo. En el supuesto que EL SUSCRIPTOR
                            no devuelva el equipo a la terminación del contrato, EL MEGANETT podrá hacer valer el pagaré
                            establecido en el Anexo 1.</p>
                        <p><strong>CUARTA: ENTREGA E INSTALACIÓN.</strong> La entrega e instalación del equipo terminal
                            no podrá ser mayor a 10 días hábiles a partir de la firma del presente contrato.</p>
                        <p>En caso de que MEGANETT no pueda iniciar la prestación del servicio por causas atribuibles a
                            él por imposibilidad física o técnica para la instalación del equipo, debe devolver al
                            SUSCRIPTOR las cantidades que haya pagado por concepto de anticipo, en un plazo no mayor de
                            30 días hábiles siguientes a la fecha límite establecida para la instalación, y se tendrá
                            por terminado el contrato de adhesión sin responsabilidad para el SUSCRIPTOR debiendo pagar
                        ...
                        <p>Las tarifas no podrán establecer condiciones contractuales tales como causas de terminación
                            ...
                            adhesión. De igual manera, no se podrán establecer términos y/o condiciones de aplicación de
                        ...
                        <p><strong>SEXTA: SERVICIOS ADICIONALES.</strong> MEGANETT puede ofrecer servicios adicionales
                            al SERVICIO originalmente contratado siempre y cuando sea acordado entre las partes y el
                            SUSCRIPTOR lo solicite y autorice a través de medios físicos, electrónicos, digitales o de
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
        <td style="border: 0; width: 48%" class="tj va-t">
            <p>El MEGANETT deberá contar con la opción de ofrecer al SUSCRIPTOR cada servicio adicional o producto por
            ...
            <p><strong>SÉPTIMA: ESTADO DE CUENTA RECIBO Y/O FACTURA.</strong> El MEGANETT debe entregar gratuitamente en
                el correo del SUSCRIPTOR, con al menos 10 días naturales antes de la fecha de vencimiento del plazo para
                el pago del SERVICIO contratado, un estado de cuenta, recibo y/o factura el cual deberá de contener de
                manera desglosada la descripción de los cargos, costos, conceptos y naturaleza del SERVICIO y de los
            ...
            <p>La fecha, forma y lugares de pago se pueden consultar por los medios señalados en la carátula del
                presente contrato.</p>
            <p>Tratándose de cargos indebidos, MEGANETT deberá efectuar la devolución correspondiente dentro de un plazo
                no mayor a los 5 días hábiles posteriores a la reclamación. Dicha devolución se efectuará por el mismo
                medio en el que se realizó el cargo indebido correspondiente y se deberá bonificar el 20% sobre el monto
            ...
            <p><strong>OCTAVA: MODIFICACIONES.</strong> MEGANETT dará aviso al SUSCRIPTOR, cuando menos con 15 días
                naturales de anticipación, de cualquier cambio en los términos y condiciones originalmente contratados.
                Dicho aviso deberá ser notificado, a través de medios físicos, electrónicos, digitales o de cualquier
                otra nueva tecnología que lo permita.</p>
            <p>En caso de que el SUSCRIPTOR no esté de acuerdo con el cambio de los términos y condiciones originalmente
                contratados, podrá optar por exigir el cumplimiento forzoso del contrato bajo las condiciones en que se
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    <tr>
        <td style="border: 0; width: 48%" class="tj va-t">
            <p><strong>DÉCIMA: CONTINUIDAD DEL SERVICIO Y BONIFICACIONES POR INTERRUPCIÓN.</strong> El MEGANETT deberá
                bonificar y compensar al suscriptor en los siguientes casos:</p>
            <p><strong>1.</strong> Cuando <strong>por causas atribuibles a el MEGANETT</strong> no se preste el servicio
                de telecomunicaciones en la forma y términos convenidos, contratados, ofrecidos o implícitos o
                información desplegada en la publicidad del MEGANETT, así como con los índices y parámetros de calidad
                contratados o establecidos por el IFT, éste debe de compensar al consumidor la parte proporcional del
                precio del servicio, plan o paquete que se dejó de prestar y como bonificación al menos el 20% del monto
            ...
            <p><strong>2.</strong> Cuando la interrupción del servicio sea <strong>por casos fortuitos o de fuerza
                    mayor</strong>, si la misma dura más de 72 horas consecutivas siguientes al reporte que realice el
                SUSCRIPTOR, el MEGANETT hará la compensación por la parte proporcional del periodo en que se dejó de
                prestar el servicio contratado, la cual se verá reflejada en el siguiente recibo y/o factura. Además, el
            ...
            <p><strong>3.</strong> Cuando se interrumpa el servicio por alguna <strong>causa previsible</strong> que
                ...
                parte proporcional del precio del servicio que se dejó de prestar, y deberá bonificar por lo menos el
                20% del monto del periodo que se afectó.</p>
            <p><strong>4.</strong> Cuando el MEGANETT realice <strong>cargos indebidos</strong>, deberá bonificar el 20%
            ...
            <p><strong>2.</strong> Reflejar en el siguiente estado de cuenta o factura, la bonificación y/o compensación
                realizada.</p>
        ...
        <td style="border: 0; width: 48%" class="tj va-t">
            ...
            <p><strong>c)</strong> Si el SUSCRIPTOR conecta aparatos adicionales por su propia cuenta, subarrienda, cede
                o en cualquier forma traspasa los derechos establecidos en el contrato, sin la autorización previa y por
            ...
            <p><strong>e)</strong> Si el SUSCRIPTOR proporciona información falsa al MEGANETT para la contratación del
                Servicio.</p>
            ...
            <p><strong>h)</strong> El SUSCRIPTOR puede cancelar, sin el pago de penas convencionales, los servicios de
            ...
            <p><strong>i)</strong> Será causa de terminación del servicio de telefonía la ejecución de la portabilidad
                numérica, los demás servicios contratados pueden continuar activos en los términos establecidos en el
                presente contrato.</p>
...
<table>
    ...
    <tr>
        <td width="160" nowrap valign="bottom">
            <p><strong>HOST:</strong> <strong>movienet.meganett.com.mx:8096</strong></p>
        </td>
        <td nowrap colspan="3" valign="bottom">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="160" nowrap valign="bottom">
            <p><strong>Portal de Usuario:https://sec.meganett.com.mx/portal/login/</strong></p>
        </td>
        <td nowrap colspan="3" valign="bottom">&nbsp;</td>
    </tr>
    <tr>
        <td width="160" nowrap valign="bottom">
            <p><strong>Usuario:Correo Electronico proporcionado</strong></p>
        </td>
        <td nowrap colspan="3" valign="bottom">&nbsp;</td>
    </tr>
    <tr>
