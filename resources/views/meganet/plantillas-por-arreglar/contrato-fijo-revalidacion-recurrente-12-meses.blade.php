...
<body>
    ...
    <header>
        <table border="0" cellspacing="0" cellpadding="0" width="100%">
            <tr>
                <td style="border: 0">
                    <img src="${data.image_src}/images/logo_meganet_oficial.png" alt="Logo Meganet" style="max-height: 100px; margin-left:30px">
                </td>
        ...
        <tr>
            <td style="border: 0; width: 48%" class="tj va-t">
                ...
                <p><strong>SÉPTIMA: ESTADO DE CUENTA RECIBO Y/O FACTURA.</strong> El MEGANETT debe entregar
                    gratuitamente en
                    el correo del SUSCRIPTOR, con al menos 10 días naturales antes de la fecha de vencimiento del plazo
                    para
                    el pago del SERVICIO contratado, un estado de cuenta, recibo y/o factura el cual deberá de contener
                    de
                ...
                <p>Tratándose de cargos indebidos, MEGANETT deberá efectuar la devolución correspondiente dentro de un
                    plazo
                    no mayor a los 5 días hábiles posteriores a la reclamación. Dicha devolución se efectuará por el
                    mismo
                    medio en el que se realizó el cargo indebido correspondiente y se deberá bonificar el 20% sobre el
                    monto
