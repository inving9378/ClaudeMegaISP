<td>
     @if (
        \Illuminate\Support\Facades\Auth::user()->can($group . '_change_' . $submodule) ||
            \Illuminate\Support\Facades\Auth::user()->isAdmin())
        <a id="change_tarif_bundle" class="mr-2" href="javascript:void(0);" toggle-modal="modalbundleserviceChange"
