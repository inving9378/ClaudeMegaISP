        ...
        <div class="ticket">
            ...
            <div class="data">
                ...
                <div class="data-row">
                    ...
                    <span class="data-value">{{ $payment->id ?? '-' }}</span>
                </div>
                <div class="data-row">
                    <span class="data-label">Número de recibo:</span>
                    <span class="data-value">{{ $payment->invoice_number ?? '-' }}</span>
                </div>
                <div class="data-row">
                    <span class="data-label">Fecha:</span>
                    <span class="data-value">{{ $payment_date }}</span>
                </div>
                <div class="data-row">
            ...
            <div class="data">
                <div class="data-row">
                    ...
                    <span class="data-value">{{ $type ?? 'Comisión por venta adicional' }}</span>
                </div>
                <div class="data-row">
                    <span class="data-label">Período pagado:</span>
            ...
            @if ($signature != null)
                <p style="text-align: center">
                    <img src="{{ $signature }}" style="width: 80px; height: 60px;" /><br>
                </p>
            @else
                <p style="text-align: center">
                    __________________
