    ...
    <ul class="sub-menu" aria-expanded="false">
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                @endif
                @if(auth()->user()->can('inventory_item_custom_model_view_inventory_item_custom_model'))
                    <li>
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                ...
                @endif
                @if(auth()->user()->can('inventory_supplier_view_supplier'))
                    <li>
                ...
                @endif
                @if(auth()->user()->can('inventory_supplier_invoice_view_supplier_invoice'))
                    <li>
                        <a href="javascript: void(0);" class="has-arrow">
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            @if(auth()->user()->can('inventory_supplier_invoice_add_supplier_invoice'))
                                <li>
