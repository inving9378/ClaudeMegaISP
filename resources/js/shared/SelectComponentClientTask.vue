...
export default {
    name: "SelectComponentClientTask",
    props: {
    ...
    setup(props, { emit }) {
        ...
        const setDataFromServer = async () => {
            loading.value = true;
            try {
                const response = await axios.post("/get-options-client-task", {
                    ...attributes.value,
                ...
                if (props.modelValue) {
                    ...
                    model.value = selected ? selected.value : props.modelValue;
                }
            } catch (error) {
        ...
        const updateModel = (val) => {
            ...
            clientMainInformationId.value = val;
            emit("update-field", {
                value: selectedValue,
