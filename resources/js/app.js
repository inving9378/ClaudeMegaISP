...
// Pestaña en la ficha de cliente (infra de ficha extensible — roadmap #5)
import EmbajadoresClientTab from "./components/module/embajadores/EmbajadoresClientTab.vue";
...
import TalentoVentasRanking from "./components/module/talento/TalentoVentasRanking.vue";
...
const app = createApp({
    components: {
        ...
        'talento-ventas-ranking': TalentoVentasRanking,
