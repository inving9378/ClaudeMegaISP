...
export default {
    ...
    setup(props, { emit }) {
        ...
        let submitButtonAction =
            props.action == "/inventory/store_zone/add"
                ? "Crear Zona"
                : "Salvar Zona";
        ...
        const initComponent = async (action) => {
            ...
            if (action == "/inventory/store_zone/add") {
                id.value = null;
                await getfieldsJson("StoreZone");
            } else {
                id.value = partnerId;
                await getfieldsEdited("StoreZone", partnerId);
            }
        };
        ...
        const getIdByAction = (action) => {
            return _.trimStart(action, "/inventory/store_zone/update/");
        };
