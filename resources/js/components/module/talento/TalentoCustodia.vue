<template>
  <div class="talento-custodia tc-wrap" :class="{ 'tc-dark': darkMode }">

    <div class="tc-card">
      <div class="tc-cardhead d-flex flex-wrap align-items-center justify-content-between gap-2 p-3">
        <h5 class="tc-h1"><i class="fa fa-boxes me-2 text-primary"></i>Custodia de Material por Colaborador</h5>
      </div>
        ...
        <div v-else>
          ...
          <div class="d-flex align-items-center gap-2 mb-3">
            ...
            <div>
              ...
              <span class="tc-status is-slate">{{ selected.colaborador?.type }}</span>
            </div>
          </div>
              ...
              <table class="table table-sm table-hover align-middle">
                ...
                <tbody>
                  <tr v-for="m in selected.movements" :key="m.id">
                    ...
                    <td>{{ m.item_name }}</td>
                    <td><span class="tc-status is-slate">{{ m.type }}</span></td>
                    <td>{{ m.quantity }}</td>
