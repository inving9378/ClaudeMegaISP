<template>
  <div class="talento-evidencia-config tc-wrap" :class="{ 'tc-dark': darkMode }">
    <div class="tc-card">
      <!-- Encabezado -->
      <div class="tc-cardhead d-flex align-items-center justify-content-between flex-wrap gap-2 p-3">
        <div>
          <h5 class="tc-h1 mb-0">Matriz de evidencias obligatorias</h5>
              ...
              <tr v-for="ev in evTypes" :key="ev.id">
                ...
                <td>
                  ...
                  <div class="d-flex flex-wrap gap-1 mt-1">
                    <span v-if="ev.es_lectura_dbm"        class="tc-status is-info">dBm</span>
                    <span v-if="ev.es_firma"              class="tc-status is-slate">Firma</span>
                    <span v-if="ev.permite_varias"        class="tc-status is-accent">Varias</span>
                    <span v-if="ev.requiere_justificacion" class="tc-status is-warn">Justif.</span>
                  </div>
                </td>
                <!-- Checkboxes -->
                <td
