...
export default {
    ...
    setup(props, { emit }) {
        ...
        let submitButtonAction =
            props.action == "/adminstracion/documentation/documentation_menu/add"
                ? "Crear Menú de Documentación"
                : "Salvar Menú de Documentación";
        ...
        const initComponent = async (action) => {
            ...
            if (action == "/administracion/documentation/documentation_menu/add") {
                id.value = null;
                await getfieldsJson("DocumentationMenu");
            } else {
                id.value = partnerId;
                await getfieldsEdited("DocumentationMenu", partnerId);
            }
        };
        ...
        const getIdByAction = (action) => {
            return _.trimStart(
                action,
                "/administracion/documentation/documentation_menu/update/"
            );
        };
