                ...
                <q-form ref="form" greedy>
                    <div class="row">
                        ...
                        <div
                            class="col-lg-6 col-xl-6 col-md-6 col-sm-12 col-xs-12"
                        >
                            <label for="object-owner">Propietario</label
                            ><q-input
                                v-model="currentObject.data.owner"
                                for="object-owner"
                                outlined
                                dense
                            />
                    ...
                    <div class="row">
                        <div
                            class="col-lg-6 col-xl-6 col-md-6 col-sm-12 col-xs-12"
                        >
                            <label for="object-ownid">ID propio</label
                            ><q-input
                                v-model="currentObject.data.ownid"
                                for="object-ownid"
                                outlined
                                dense
                            />

                            <label for="object-grantid" class="q-mt-md"
                                >ID de concesión</label
                            ><q-input
                                v-model="currentObject.data.grantid"
                                for="object-grantid"
                                outlined
                                dense
                            />

                            <label for="object-monthly_rent" class="q-mt-md"
                                >Alquiler mensal</label
                            ><q-input
                                v-model="currentObject.data.monthly_rent"
                                type="number"
                                for="object-monthly_rent"
                                outlined
                                dense
                            />

                            <label for="object-group" class="q-mt-md"
                                >Grupo</label
                            ><q-input
                                v-model="currentObject.data.group"
                                for="object-group"
                                outlined
                                dense
                            />
...
const storeOrSave = async () => {
    ...
    if (object !== null) {
        ...
        if (currentObject.value.id) {
            ...
            message("Poste modificado correctamente");
        } else {
            emits("created", object);
            message("Poste agregado correctamente");
        }
