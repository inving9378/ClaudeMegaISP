                ...
                <q-form ref="form" greedy>
                    <div class="row">
                        ...
                        >
                            ...
                            <label for="object-fibers" class="q-mt-md"
                                >Cantidad de fibras</label
                            >
                            <q-input
                                v-model.number="
                                    currentObject.data.fibers_amount
                                "
                                type="number"
                                for="object-fibers"
                                outlined
                        ...
                        >
                            <label for="object-color"
                                ...
                                <q-badge
                                    :style="{
                                        'background-color': currentObject.color,
                                    }"
                                    >{{ currentObject.color }}</q-badge
                                ></label
                            >
                            <q-color
                                v-model="currentObject.color"
                                no-header
                                no-footer
                            ...
                            <label for="object-weight" class="q-mt-md q-mb-none"
                                >Ancho
                                <q-badge
                                    :style="{
                                        'background-color': currentObject.color,
                                        'min-height': `${currentObject.weight}px`,
                                    }"
                                    >{{ currentObject.weight }}</q-badge
                                ></label
                            >
                            <q-slider
                                v-model="currentObject.weight"
                                :step="1"
                                :min="1"
                                :max="10"
                            />
...
const setDefaultData = () => {
    currentObject.value = props.object
        ...
        : {
              ...
              data: {
                  name: null,
                  map_proyect_id: props.project.id,
                  description: null,
                  fibers_amount: null,
              },
          };
