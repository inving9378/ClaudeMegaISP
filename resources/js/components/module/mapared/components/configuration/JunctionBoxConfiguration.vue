    ...
    >
        ...
        >
            <q-header>
                <q-toolbar>
                    ...
                    <q-btn
                        ...
                        ><q-tooltip>Uniones de hilos de esta mufa</q-tooltip></q-btn
                    >
                    <q-btn
                        icon="close"
                        flat
            ...
            <q-footer
                ...
                v-if="dropOut && tabCharoles !== 'marker-information'"
            >
                <drop-out
                    :device="dropOut"
                    :has-edit="hasEdit"
...
import BoxJunctionComponent from "../BoxJunctionComponent.vue";
