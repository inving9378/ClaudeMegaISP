            ...
            <q-page-container>
                <q-page>
                    ...
                    >
                        ...
                        >
                            <div
                                @mousedown="startDrag($event, index, 'devices')"
                            >
                                <router-component
                                    :device="device"
                                    :has-edit="hasEdit"
                                ...
                                <organizer-component
                                    ...
                                    @toggle="togglePort"
                                    @redraw="onRedraw"
                                    v-else-if="device.type === 'organizer'"
                                />
                                <olt-component
                                    :device="device"
                                    :has-edit="hasEdit"
...
import CupboardComponent from "../CupboardComponent.vue";
...
const onShowDialog = () => {
    ...
    tabDevice.value =
        tab && tab.type === "rack" && tab.key === props.object.key
            ? tab.tab
            : "marker-information";
    setToLocalStorage("dialog-config", "cupboard_config");
...
const handleMouseUp = () => {
    if (props.hasEdit) {
        ...
        if (
            ...
            if (dragging.type === "devices") {
                saveDevice(s);
            } else if (dragging.type === "routes") {
