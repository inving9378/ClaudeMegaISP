<template>
    <q-table
        ...
        row-key="id"
        color="primary"
        loading-label="Obteniendo subscripciones, por favor espere..."
        no-data-label="No existen subscripciones disponibles"
        no-results-label="No se encontraron coincidencias"
        rows-per-page-label="Subscripciones por página"
...
const columns = ref([
    ...
    },
    {
        ...
        sortable: true,
        classes: (row) => {
            return row.end_subscription_days <= 10
    ...
    },
    {
        ...
        label: "Finalización de suscripción (inclusive)",
        align: "left",
        sortable: true,
        classes: (row) => {
            return row.end_subscription_days <= 10
