                ...
                <q-form ref="form" greedy>
                    <div class="row">
                        ...
                        >
                            ...
                            <label for="object-ipv4" class="q-mt-sm">IPv4</label
                            ><q-input
                                v-model="currentObject.data.ipv4"
                                for="object-ipv4"
                                outlined
                                dense
                            />

                            <label for="object-ipv6" class="q-mt-sm">IPv6</label
                            ><q-input
                                v-model="currentObject.data.ipv6"
                                for="object-ipv6"
                                outlined
                                dense
                            />

                            <label for="object-mac" class="q-mt-sm"
                                >Dirección física</label
                            ><q-input
                                v-model="currentObject.data.mac"
                                for="object-mac"
                                outlined
                                dense
                            />

                            <label for="object-description" class="q-mt-sm"
                                >Descripción</label
                            ><q-input
...
const storeOrSave = async () => {
    ...
    if (object !== null) {
        ...
        if (currentObject.value.id) {
            ...
            message("Pack modificado correctamente");
        } else {
            emits("created", object);
            message("Pack agregado correctamente");
        }
