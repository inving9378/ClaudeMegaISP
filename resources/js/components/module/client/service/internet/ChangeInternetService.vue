...
export default {
    ...
    setup(props, { emit }) {
        ...
        const title = ref("Cambiar Servicio de Internet");
        ...
        const getfieldsEditedInternetService = async (model, action) => {
            ...
            show.value = true;
            title.value = "Cambiar Servicio de Internet";
        ...
        const onSubmit = () => {
            dataForm.data
                .submit(
                    "post",
                    `/cliente/clientinternetservice/change-internet/${idModel.value}`,
                    props.action
                )
                .then((response) => {
