                ...
                <div class="modal-body m-0">
                    ...
                    >
                        ...
                        <div v-show="show">
                            ...
                            <template v-for="val in fieldsJson['other']">
                                <ComponentFormDefault
                                    v-if="val.include"
                                    :id="idClient"
                                    :json="val"
...
export default {
    ...
    setup(props, { emit }) {
        ...
        const title = ref("Crear Servicio de Voz");
        ...
        const initComponent = async (action) => {
            action == `crear/${props.idClient}`
                ? await getfieldsJson("ClientVozService")
                : await getfieldsEditedVozService(
                      "ClientVozService",
                      props.action
                  );
        };
        ...
        const getfieldsEditedVozService = async (model, action) => {
            ...
            show.value = true;
            title.value = "Editar Servicio de Voz";
        ...
        const getfieldsJson = async (model) => {
            ...
            show.value = false;
            title.value = "Crear Servicio de Voz";
        ...
        const onSubmit = () => {
            dataForm.data
                .submit(
                    "post",
                    `/cliente/clientvozservice/${props.action}`,
                    props.action
                )
                .then((response) => {
