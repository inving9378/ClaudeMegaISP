<template>
    <div class="megafamilia-terminos">
        <div class="card mt-3">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title m-0">Términos</h5>
                    <div>
                        <input
                            v-if="hasSearch"
                            v-model="search"
                ...
                <div class="text-muted small mt-3">
                    ...
                    Pendiente: refinar UI con patrón <code>acceptance-table</code>.
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        async fetch() {
            ...
            try {
                ...
                const { data } = await axios.get(`${this.baseUrl}/terminos/data`, { params });
                this.normalize(data);
            } catch (e) {
