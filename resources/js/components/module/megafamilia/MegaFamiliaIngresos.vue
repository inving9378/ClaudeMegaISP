<template>
    <div class="megafamilia-ingresos">
        <div class="card mt-3">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title m-0">Ingresos</h5>
                    <div>
                        <input
                            v-if="hasSearch"
                            v-model="search"
                ...
                <div class="text-muted small mt-3">
                    ...
                    Pendiente: refinar UI con patrón <code>cards-and-bars</code>.
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        async fetch() {
            ...
            try {
                ...
                const { data } = await axios.get(`${this.baseUrl}/ingresos/data`, { params });
                this.normalize(data);
            } catch (e) {
