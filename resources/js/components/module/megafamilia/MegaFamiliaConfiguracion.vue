<template>
    <div class="megafamilia-configuracion">
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="text-muted small mt-3">
                    ...
                    Pendiente: refinar UI con patrón <code>settings-groups</code>.
                </div>
            </div>
        </div>
    </div>
    ...
    methods: {
        async fetch() {
            ...
            try {
                ...
                const { data } = await axios.get(`${this.baseUrl}/configuracion/get`, { params });
                this.normalize(data);
            } catch (e) {
