...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $fields = [
            [
                ...
                'label' => 'Enviar notificaciones automáticamente después de crear un pago',
                'placeholder' => '',
                'type' => 16,
                'position' => 1,
            ...
            [
                'name' => 'attach_invoice',
                'label' => 'Adjuntar factura relacionada / factura proforma',
                'placeholder' => '',
                'type' => 16,
                'position' => 11,
                'additional_field' => false,
    ...
    {
        $module = Module::where('name', 'ConfigFinanceNotificationPayment')->first();
