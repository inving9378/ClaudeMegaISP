...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        ConfigFinanceNotification::create([
            'group' => 'Recurrent',
            'type_config' => 'recurrent_blocking_wave',
        ...
        $module = Module::create([
            'name' => 'ConfigFinanceNotificationRecurrentBlockingWave',
            'group' => 'Configuration',
            'is_main' => false,
        ...
        ConfigFinanceNotification::create([
            'group' => 'Recurrent',
            'type_config' => 'recurrent_inactive_wave',
            'auto_send_notifications' => false,
            'message_type' => 'email',
            'email_template_id' => 3,
            'sms_template' => null,
        ...
        $module = Module::create([
            'name' => 'ConfigFinanceNotificationRecurrentInactiveWave',
            'group' => 'Configuration',
            'is_main' => false,
            'main' => 'App\Models\ConfigFinanceNotification',
        ]);
        ...
        $fields = [
            [
                'name' => 'auto_send_notifications',
                'label' => 'Enviar una notificación después de establecer el estado del cliente como inactivo',
                'placeholder' => '',
                'type' => 16,
                'position' => 1,
                'additional_field' => false,
    ...
    {
        $module = Module::where('name', 'ConfigFinanceNotificationRecurrentBlockingWave')->first();
        $module->fields()->delete();
        $module->packages()->detach();
        $module->delete();
        ConfigFinanceNotification::where('type_config', 'recurrent_blocking_wave')->delete();

        $module = Module::where('name', 'ConfigFinanceNotificationRecurrentInactiveWave')->first();
        $module->fields()->delete();
        $module->packages()->detach();
        $module->delete();
        ConfigFinanceNotification::where('type_config', 'recurrent_inactive_wave')->delete();
