...
return new class extends Migration
{
    ...
    public function up(): void
    {
        $module = Module::create([
            'name' => 'ConfigFinanceNotification',
            'group' => 'Configuration',
        ]);
        ...
        $module = Module::create([
            'name' => 'ConfigFinanceNotificationInvoice',
            'group' => 'Configuration',
            'is_main' => false,
    ...
    {
        $module = Module::where('name', 'ConfigFinanceNotificationInvoice')->first();
        $module->fields()->delete();
        $module->packages()->detach();
        $module->delete();

        $module = Module::where('name', 'ConfigFinanceNotification')->first();
        $module->packages()->detach();
        $module->delete();
    }
};
