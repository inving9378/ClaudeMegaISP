...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $ckeditor = [23];
        $choices = [21, 22];
        $bootstrap_multiselect_toaster_datatables_packages = Arr::collapse([$bootstrap_multiselect, $toaster, $datatables_packages, $select2, $chosen_select, $ckeditor, $choices]);
