...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $module->fields()->where('name', 'discount_value')->update([
            'type' => 30,
        ]);

        $module->fields()->where('name', 'discount_value_fixed')->update([
            'type' => 30,
        ]);
        ...
        Schema::table('bundles', function (Blueprint $table) {
            $table->string('promotion_enable')->nullable()->after('discount_value')->nullable();
