...
return new class extends Migration
{
    ...
    {
        Schema::create('proforma_invoice_emails', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('proforma_invoice_emails');
        $module = Module::where('name', 'ProformaInvoiceEmail')->first();
