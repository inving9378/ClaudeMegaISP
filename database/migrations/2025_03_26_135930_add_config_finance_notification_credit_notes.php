...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $fields = [
            ...
            [
                'name' => 'attach_invoice',
                'label' => 'Adjuntar factura relacionada',
                'placeholder' => '',
                'type' => 16,
                'position' => 11,
                'additional_field' => false,
    ...
    {
        $module = Module::where('name', 'ConfigFinanceNotificationCreditNotes')->first();
        $module->fields()->delete();
        $module->packages()->detach();
        $module->delete();
        ConfigFinanceNotification::where('type_config', 'credit_notes')->delete();
    }
};
