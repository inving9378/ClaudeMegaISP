...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $permissions = [
            ...
            'service_in_address_list_add_service_in_address_list',
            'service_in_address_list_edit_service_in_address_list',
            'service_in_address_list_delete_service_in_address_list'
        ];
