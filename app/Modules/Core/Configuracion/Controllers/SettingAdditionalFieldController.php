...
use App\Modules\Core\Configuracion\Repositories\FieldModuleRepository;
...
class SettingAdditionalFieldController extends Controller
{
    ...
    {
        $this->data['model'] = 'App\Modules\Core\Configuracion\Models\FieldModule';
        $this->data['url'] = 'core-configuracion::additionalfield';
    ...
    public function index()
    {
        ...
        return view('core-configuracion::additionalfield.listar', $this->data);
    }
