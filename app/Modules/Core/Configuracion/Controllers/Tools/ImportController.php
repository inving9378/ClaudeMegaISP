...
namespace App\Modules\Core\Configuracion\Controllers\Tools;
...
class ImportController extends Controller
{
    ...
    public function __construct(SettingTollsImportDatatableHelper $helper)
    {
        ...
        $this->data['url'] = 'core-configuracion::tools.import';
    ...
    public function index()
    {
        ...
        return view('core-configuracion::tools.import.listar', $this->data);
    }
