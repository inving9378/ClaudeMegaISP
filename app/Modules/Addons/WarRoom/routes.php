...
use App\Modules\Addons\WarRoom\Controllers\MeetingHistoryController;
...
Route::middleware(['web', 'auth'])->prefix('warroom')->group(function () {
    ...
    Route::middleware('permission:warroom.view')->group(function () {
        ...
        Route::get('/api/meetings', [MeetingHistoryController::class, 'index']);
        Route::get('/api/meetings/{meeting}/detalle', [MeetingHistoryController::class, 'show']);
