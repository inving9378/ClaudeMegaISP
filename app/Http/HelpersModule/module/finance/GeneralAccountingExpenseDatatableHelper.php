...
class GeneralAccountingExpenseDatatableHelper extends HelperDatatable
{
    ...
    {
        $this->model = GeneralAccountingExpense::class;
        $moduleName = 'GeneralAccountingExpense';
    ...
    public function transform($request)
    {
        ...
        if (!empty($request['array'])) {
            foreach ($request['array'] as $key => $value) {
                ...
                $info = [
                    'id' => $id,
                    'module' => 'GeneralAccountingExpense',
                    'group' => 'finance',
                    'submodule' => 'general_accounting_expense',
