...
namespace App\Http\HelpersModule\module\administration\document_type_template;
...
class DocumentTypeTemplateDatatableHelper extends HelperDatatable
{
    private $model, $columns, $moduleName;

    public function __construct()
    {
        $this->model = DocumentTypeTemplate::class;
        $this->moduleName = 'DocumentTypeTemplate';
        $this->columns = Module::where('name', 'DocumentTypeTemplate')->first()->columnsDatatable->pluck('name')->toArray();
    }
