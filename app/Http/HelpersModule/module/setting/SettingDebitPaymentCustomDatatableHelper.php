...
class SettingDebitPaymentCustomDatatableHelper extends HelperDatatable
{
    private $model, $columns;

    public function __construct()
    {
        $this->model = SettingDebtPaymentClientCustom::class;
        $moduleName = 'SettingDebtPaymentClientCustom';
    ...
    public function transform($request)
    {
        ...
        if (!empty($request['array'])) {
            foreach ($request['array'] as $key => $value) {
                ...
                $info = [
                    'id' => $id,
                    'module' => 'SettingDebtPaymentClientCustom',
                    'group' => 'debitcustom',
                    'submodule' => 'debitcustom'
                ];
