...
namespace App\Http\HelpersModule\module\base;

use App\Http\HelpersModule\module\HelperDatatable;
use App\Models\Module;
use Illuminate\Support\Arr;

class HelperModuleDatatable extends HelperDatatable
{
    protected $model, $columns, $moduleName;

    public function __construct($model, $moduleName)
    {
        $this->model = $model;
    ...
    {
        return !empty(isset($request['request']->modal['modal']));
    }
}
