...
--
-- Table structure for table `talento_responsibility_windows`
--
...
--
-- Dumping data for table `talento_responsibility_windows`
--

LOCK TABLES `talento_responsibility_windows` WRITE;
/*!40000 ALTER TABLE `talento_responsibility_windows` DISABLE KEYS */;
/*!40000 ALTER TABLE `talento_responsibility_windows` ENABLE KEYS */;
UNLOCK TABLES;
