...
--
-- Table structure for table `talento_warranty_overrides`
--
...
--
-- Dumping data for table `talento_warranty_overrides`
--

LOCK TABLES `talento_warranty_overrides` WRITE;
/*!40000 ALTER TABLE `talento_warranty_overrides` DISABLE KEYS */;
/*!40000 ALTER TABLE `talento_warranty_overrides` ENABLE KEYS */;
UNLOCK TABLES;
