...
--
-- Table structure for table `talento_work_order_activations`
--
...
--
-- Dumping data for table `talento_work_order_activations`
--

LOCK TABLES `talento_work_order_activations` WRITE;
/*!40000 ALTER TABLE `talento_work_order_activations` DISABLE KEYS */;
/*!40000 ALTER TABLE `talento_work_order_activations` ENABLE KEYS */;
UNLOCK TABLES;
