...
--
-- Table structure for table `talento_route_stops`
--
...
--
-- Dumping data for table `talento_route_stops`
--

LOCK TABLES `talento_route_stops` WRITE;
/*!40000 ALTER TABLE `talento_route_stops` DISABLE KEYS */;
/*!40000 ALTER TABLE `talento_route_stops` ENABLE KEYS */;
UNLOCK TABLES;
