 ...
 * (`jarvis.escalamiento` / `JarvisService::categoriaFronteraDura()`). Antes de #944 el motivo que
 ...
 * de Jarvis (fuera de alcance — decisión de diseño aparte, `plan-configuracion-torre.md` fase 6)
 * NO se tocan aquí.
 *
...
class RevisorAlcanceNoSeLlamaFronteraDuraTest extends TestCase
{
    ...
    public function test_motivo_de_en_alcance_no_dice_frontera_dura_a_secas(): void
    {
        ...
        $this->assertStringNotContainsString('(frontera dura dinero/seguridad/prod/negocio)', $cuerpo,
            ...
            . 'es un prefiltro PROPIO del Revisor, distinto de `jarvis.escalamiento`.');
    ...
    public function test_motivo_de_en_alcance_se_distingue_de_la_frontera_de_jarvis(): void
    {
        $cuerpo = $this->metodo($this->fuente(), 'enAlcance');
        ...
        $this->assertStringContainsString('denylist propia', $cuerpo,
            ...
            . 'distinta de la frontera dura de Jarvis — el punto central del rename de #944.');
    }
}
